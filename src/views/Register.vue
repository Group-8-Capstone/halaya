    ...
    <v-app id="inspire">
        ...
        >
            ...
            >
                ...
                >
                    <v-list-item-content>
                    <v-list-item-title class="d-flex align-center justify-center pa-6 mx-auto headline">SIGN UP</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
...
export default {
    ...
    methods: {
        signUp(){
            ...
            axios.post("https://wawenshalaya.herokuapp.com/api/register", Reg).then((response) =>{
                console.log(Reg);

                ...
                <v-row class="mx-2">
                  ...
                  <v-col cols="12">
                    ...
                    >
                      ...
                      <v-date-picker v-model="post.delivery_date"  color="deep-purple lighten-1" no-title scrollable>
                        <v-spacer></v-spacer>
                      </v-date-picker>
                 </v-menu>
                  </v-col>
...
export default {
  ...
  computed:{
    ...
    customerErrors () {
     ...
     contactNumberErrors () {
      ...
      !this.$v.contactNumber.minLength && errors.push('Contact Number must be at atleast 11 characters long')
      !this.$v.contactNumber.maxLength && errors.push('Contact Number must not be greater than 11 characters long')
      !this.$v.contactNumber.required && errors.push('Contact Number is required.')
      return errors
    },
    getEndDate() {
     var endDate = new Date(this.date2.getFullYear(), this.date2.getMonth() + 1, 10);
  ...
  {   
    ...
    updateItem(){
       if (this.post.customer_name===""||this.post.customer_address===""||this.post.order_quantity===""

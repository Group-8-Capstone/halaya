  ...
  <v-card class="mx-auto my-2" max-width="1000">
    <v-card dark flat>
      <v-card-title class="pa-2 purple lighten-3">
        ...
        <!-- <v-avatar class="ml-50 mr-50">
            <v-img src="../assets/wawens.png"></v-img>
        </v-avatar> -->
        <h3 class="title font-weight-light text-center grow">Delivery</h3>
        <v-btn icon class="mr-10">Print as PDF</v-btn>
      </v-card-title>
      <v-img
      ...
      >
        <v-container>
          <v-row>
            <div class="headline font-weight-light">October 11, 2020</div>
          </v-row>
        </v-container>
      </v-img>
    </v-card>

<template>
  <v-app id="inspire">
    ...
    <v-list-item-avatar size="60">
      ...
      <v-spacer></v-spacer>
        <!-- <div class="ma-5">
             <v-item class="deep-purple--text">Admin Login</v-item>   
...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      { icon: "mdi-cogs", text: "Settings", link: "/setting" },
    ],
     items2: [
        {icon: "mdi-account-settings", title: 'Profile Setting',link: "/profileSetting"  },
